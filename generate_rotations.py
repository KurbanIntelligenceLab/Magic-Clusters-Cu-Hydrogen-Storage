...
def create_atom_image(coords: np.ndarray, atoms: List[str], size: int = 128) -> np.ndarray:
    ...
    bounds = [min_coords[0] - padding[0], max_coords[0] + padding[0],
              min_coords[1] - padding[1], max_coords[1] + padding[1]]
...
def process_xyz_file(xyz_path: str, output_dir: str, num_rotations: int = 5):
    ...
    for i in range(num_rotations):
        ...
        cv2.imwrite(os.path.join(image_output_dir, f"{base_name}_rot{i+1}.png"), rotated_image)
